...
const LandingPage = () => {
  ...
  const htmlContent = (
    <div style={{ width: '100vw', color: '#fff', fontFamily: "'Inter', system-ui, sans-serif", cursor: 'none' }}>
      ...
      {/* ── Section 2: The 2 Rules (page 2 of 4) ──── */}
      ...
      {/* ── Section 3: Manual Chase (page 3 of 4) ── */}
      <section style={{
        minHeight: '100vh',
        display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center',
        padding: '80px 24px',
      ...
      {/* ── Section 4: Final CTA (page 4 of 4) ──── */}
      <section style={{
        minHeight: '100vh',
        display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center',
  ...
  return (
    <div style={{ cursor: 'none' }}>
      <BallCursor />
      <HeroScene>{htmlContent}</HeroScene>
    </div>
  );
};
